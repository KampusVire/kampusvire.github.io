    ...
    return (
        ...
        {step === 1 ? (
            ...
            : step === 2 ? (
                ...
                step === 3 ? (
                    <div>
                        <h1 class="text-center nunito_sans mt-5 mb-3">Wallet Id</h1>
                        <p class="text-muted fs-6 px-3 open_sans">
                            Hey this is your special wallet Id . Note it down somewhere secure .We would ask for confirmation
                        </p>
                        <div class="fs-6 px-3 open_sans border p-3 mx-3 my-4 bg-light">{mnemonicCelo}</div>

                        <div class="d-grid gap-2 d-md-block container button">
                            <button class="btn btn-success bg-green text-uppercase" onClick={() => setStep(4)}>Done</button>
                        </div>
                        ...
                        step === 5 ? (
                            <div>
                                ...
                                <div class="my-5 container">
                                    <div class="fs-5 nunito_sans px-3">Hi there !</div>
                                    <div class="fs-6 text-muted nunito_sans px-3 mb-4">You are new here,quickly fill this up</div>
                                    <form>
                                        <div class="mb-3">
                                            <input class="form-control text-muted open_sans text-uppercase fst-italic fs-6 py-2" placeholder="Your Name" id="name" onChange={(event) => { registerData.current["name"] = event.target.value }} />
                                        </div>
                                        <div class="mb-3">
                                            <input class="form-control text-muted open_sans fst-italic fs-6 py-2" placeholder="Your EmailID" id="emailid" onChange={(event) => { registerData.current["email_id"] = event.target.value }} />
                                        </div>
                                        <div class="mb-3">
                                            <input class="form-control text-muted open_sans text-uppercase fst-italic fs-6 py-2" placeholder="Your College Name" id="college_name" onChange={(event) => { registerData.current["college_name"] = event.target.value }} />
                                        </div>
                                        <div class="mb-3">
                                            <input type="text" class="form-control text-muted open_sans fst-italic fs-6 py-2" placeholder="YOUR ROLL NUMBER" id="roll_no" onChange={(event) => { registerData.current["roll_no"] = event.target.value }} />
                                        </div>
                                        <div class="mb-3">
                                            <input type="text" class="form-control text-muted open_sans text-uppercase fst-italic fs-6 py-2" placeholder="DEPARTMENT" id="department" onChange={(event) => { registerData.current["department"] = event.target.value }} />
                                        </div>
                                        <div class="mb-3">
                                            <input type="text" class="form-control text-muted open_sans fst-italic fs-6 py-2" placeholder="YEAR" id="year" onChange={(event) => { registerData.current["year"] = event.target.value }} />
                                        </div>
                                        {/* <div class="mb-3">
                                            <label for="formFile" class="form-label open_sans fs-6">Student ID-Card</label>
                                ...
                                <div class="d-grid gap-2 d-md-block container button">
                                    <button class="btn btn-success bg-green text-uppercase" onClick={registerUser}>Done</button>
                                </div>
